...
class TopNewsCell: UITableViewCell {
    ...
    func setupCell() {
        ...
        headline.anchor(top: container.topAnchor, leading: container.leadingAnchor, bottom: date.topAnchor, trailing: container.trailingAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 0)
        date.anchor(top: headline.bottomAnchor, leading: nil, bottom: nil, trailing: headline.trailingAnchor, paddingTop: 4, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 0)
        imageBox.anchor(top: date.bottomAnchor, leading: headline.leadingAnchor, bottom: nil, trailing: headline.trailingAnchor, paddingTop: 8, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 200)
        articleText.anchor(top: imageBox.bottomAnchor, leading: imageBox.leadingAnchor, bottom: container.bottomAnchor, trailing: imageBox.trailingAnchor, paddingTop: 8, paddingLeft: 0, paddingBottom: 4, paddingRight: 0, width: 0, height: 0)
